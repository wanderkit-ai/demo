'use client'
import { Star, MapPin, Tag, DollarSign, AlertCircle, CheckCircle } from 'lucide-react'
...
export default function OperatorCard({ operator, onContact, showMatchScore }: OperatorCardProps) {
  ...
  return (
    <div className="bg-white border border-notion-border rounded-xl p-5 hover:border-brand-200 hover:shadow-sm transition-all">
      {/* Header */}
